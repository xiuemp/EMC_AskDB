...
def scatter(source_path, output_path='./', x_label_tip='', y_label_tip='', y_min='', y_max=''):
    """
    ...
    # define range of coordinate
    if y_min == '' and y_max == '':
        plt.axis([begin-0.05*(end-begin),end+0.05*(end-begin),bottom,top])
    elif y_min == '':
        plt.axis([begin-0.05*(end-begin),end+0.05*(end-begin),bottom,float(y_max)])
    elif y_max == '':
        plt.axis([begin-0.05*(end-begin),end+0.05*(end-begin),float(y_min),top])
    else:
        plt.axis([begin-0.05*(end-begin),end+0.05*(end-begin),float(y_min),float(y_max)])
    ...
    if not output_path[-1] == '/':
        output_path += '/'
    file_name = os.path.splitext(os.path.basename(source_path))[0]+"("+y_min+","+y_max+")"
